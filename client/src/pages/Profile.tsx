...
const Profile = () => {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      toast({
        title: "Profile Blessed",
        description: "Your profile has been successfully updated with divine energy.",
        variant: "default"
      });
  ...
  const LoadingSpinner = () => (
    ...
    >
      ...
      <p className="text-amber-600 text-lg font-medium" style={{ fontFamily: "'Playfair Display', serif" }}>Loading your divine profile...</p>
    </div>
  );
  ...
  if (!user) {
    return (
      <>
        ...
        >
          <div className="text-center max-w-md p-8 bg-white rounded-3xl shadow-xl border border-amber-200">
            <div className="w-16 h-16 bg-gradient-to-r from-amber-100 to-orange-50 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <p className="text-base text-gray-600 mb-8 leading-relaxed">
              You need to be logged in to view your divine profile information.
            </p>
            <button 
              onClick={() => navigate('/login')}
              className="inline-flex items-center gap-2 rounded-full px-8 py-3 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
            >
              Go to Login
            </button>
          </div>
  ...
  return (
    <>
      ...
      >
        ...
        <div className="fixed bottom-40 right-10 w-48 h-48 rounded-full bg-amber-100/20 blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        ...
        <div className="max-w-4xl xl:max-w-5xl mx-auto relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-amber-100 to-orange-50 text-amber-700 px-6 py-2 rounded-full text-sm font-semibold mb-6 border border-amber-200">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Manage your sacred account information and spiritual preferences
            </p>
          </motion.div>
          ...
          {loading ? (
            ...
            <>
              ...
              <motion.div 
                className="bg-white rounded-3xl shadow-xl border border-amber-200 p-8 mb-6"
                style={{
              ...
              >
                <div className="flex flex-col items-center">
                  <div className="relative group">
                    <div className="w-32 h-32 bg-gradient-to-r from-amber-600 to-orange-500 rounded-full flex items-center justify-center shadow-lg">
                  ...
                  <div className="text-center mt-6">
                    ...
                    <div className="flex gap-4 items-center justify-center">
                      <div className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-50 to-amber-50 px-4 py-2 rounded-full border border-amber-200">
                        <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                        <span className="text-sm font-medium text-amber-600">Active Divine Account</span>
                      </div>
                      ...
                      {currentProfile.isPhoneVerified && (
                        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-green-50 to-emerald-50 px-4 py-2 rounded-full border border-green-200">
                          ...
                          <span className="text-sm font-medium text-green-700">Phone Blessed</span>
                        </div>
                      )}
                    </div>
                  </div>
              ...
              >
                <button
                  ...
                  className="flex flex-col items-center p-4 bg-white rounded-2xl shadow-lg border border-amber-200 hover:shadow-xl transition-all duration-300 hover:scale-105"
                  style={{
                    background: "linear-gradient(135deg, rgba(255,255,255,.98) 0%, rgba(254,243,231,.98) 60%, rgba(254,215,170,.98) 100%)",
                  }}
                >
                  <Package className="w-8 h-8 text-amber-600 mb-2" />
                  <span className="text-sm font-semibold text-gray-900">My Sacred Orders</span>
                </button>
                ...
                >
                  ...
                  <span className="text-sm font-semibold text-gray-900">Sacred Collection</span>
                </button>
                ...
                >
                  ...
                  <span className="text-sm font-semibold text-gray-900">Divine Hampers</span>
                </button>
                ...
                >
                  ...
                  <span className="text-sm font-semibold text-gray-900">Bless Profile</span>
                </button>
              </motion.div>

              {/* Profile Information Grid */}
              <motion.div 
                className="bg-white rounded-3xl shadow-xl border border-amber-200 p-8"
                style={{
                  background: "linear-gradient(135deg, rgba(255,255,255,.98) 0%, rgba(254,243,231,.98) 60%, rgba(254,215,170,.98) 100%)",
                }}
                initial={{ opacity: 0, y: 20 }}
                ...
                {isEditing && (
                  <div className="flex items-center justify-between mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-semibold text-blue-800">Blessing Your Profile</span>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-8 h-8 bg-gradient-to-r from-amber-100 to-orange-50 rounded-lg flex items-center justify-center">
                        <User className="w-4 h-4 text-amber-600" />
                      </div>
                      <h3 className="text-xl font-bold text-gray-900" style={{ fontFamily: "'Playfair Display', serif" }}>Divine Details</h3>
                    </div>

                    {/* First Name */}
                    <div className="bg-gradient-to-br from-amber-50/50 to-amber-50/30 p-6 rounded-2xl border border-amber-100 hover:shadow-lg transition-all duration-300">
                      ...
                      {isEditing ? (
                        <Input
                          ...
                          className="text-lg font-bold border-amber-200 focus:border-amber-500"
                    ...
                    <div className="bg-gradient-to-br from-amber-50/50 to-amber-50/30 p-6 rounded-2xl border border-amber-100 hover:shadow-lg transition-all duration-300">
                      ...
                      <p className="text-sm text-amber-500 mt-1">Email cannot be changed</p>
                    </div>
                        ...
                        <div>
                          ...
                          {currentProfile.isPhoneVerified && (
                            <div className="flex items-center gap-1 mt-2">
                              <CheckCircle className="w-4 h-4 text-green-500" />
                              <span className="text-sm text-green-600 font-medium">Blessed</span>
                            </div>
                          )}
                        </div>
                      )}
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <h3 className="text-xl font-bold text-gray-900" style={{ fontFamily: "'Playfair Display', serif" }}>Sacred Address & Account</h3>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-amber-50/50 to-amber-50/30 p-6 rounded-2xl border border-amber-100 hover:shadow-lg transition-all duration-300">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <label className="text-sm font-semibold text-amber-800 uppercase tracking-wide">Sacred Address</label>
                      </div>
                      {isEditing ? (
                    ...
                    <div className="bg-gradient-to-br from-amber-50/50 to-amber-50/30 p-6 rounded-2xl border border-amber-100 hover:shadow-lg transition-all duration-300">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-amber-500 to-orange-500 text-white capitalize">
                          {currentProfile.role || 'divine seeker'}
                        </span>
                    ...
                    <div className="bg-gradient-to-br from-amber-50/50 to-amber-50/30 p-6 rounded-2xl border border-amber-100 hover:shadow-lg transition-all duration-300">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <label className="text-sm font-semibold text-amber-800 uppercase tracking-wide">Divine Member Since</label>
                      </div>
                      <p className="text-xl font-bold text-gray-900">
                        {formatDate(currentProfile.createdAt, 'MMMM d, yyyy')}
                      </p>
                      <p className="text-sm text-amber-500 mt-1">
                        {formatDate(currentProfile.createdAt, "'Blessed on' EEEE 'at' h:mm a")}
                      </p>
                    </div>

                    {/* Verification Status */}
                    <div className="bg-gradient-to-br from-amber-50/50 to-amber-50/30 p-6 rounded-2xl border border-amber-100 hover:shadow-lg transitionall duration-300">
                      <div className="flex items-center gap-3 mb-3">
                        <Award className="w-5 h-5 text-amber-600" />
                        <label className="text-sm font-semibold text-amber-800 uppercase tracking-wide">Divine Verification</label>
                      </div>
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-amber-600">Email Blessed</span>
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-amber-600">Phone Blessed</span>
                          <div className="flex items-center gap-1">
                            {currentProfile.isPhoneVerified ? (
                              <>
                                <CheckCircle className="w-4 h-4 text-green-500" />

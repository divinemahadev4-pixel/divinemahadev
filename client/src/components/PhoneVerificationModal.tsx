      ...
      {showPhoneVerification && (
        ...
        >
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-orange-500 via-amber-500 to-orange-600 text-white px-4 py-5 sm:px-6 sm:py-6">
              ...
              {!showOTPInput ? (
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    <div className="w-16 h-16 sm:w-18 sm:h-18 bg-gradient-to-br from-orange-50 to-amber-100 rounded-3xl flex items-center justify-center mx-auto mb-4 border border-orange-200">
                      <Phone className="w-8 h-8 sm:w-9 sm:h-9 text-orange-600" />
                    </div>
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        <Input
                          ...
                          required
                          className="h-12 sm:h-14 text-base sm:text-lg border-2 border-gray-200 focus:border-orange-500 focus:ring-3 focus:ring-orange-100 rounded-2xl transition-all duration-200 bg-gray-50 focus:bg-white group-hover:border-gray-300 text-center tracking-wide font-medium"
                          maxLength={10}
                        />
                    ...
                    <Button
                      ...
                      className="w-full h-12 sm:h-14 text-base sm:text-lg font-bold rounded-2xl bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isVerifyingPhone ? (
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    <div className="w-16 h-16 sm:w-18 sm:h-18 bg-gradient-to-br from-orange-50 to-amber-100 rounded-3xl flex items-center justify-center mx-auto mb-4 border border-orange-200">
                      <MessageSquare className="w-8 h-8 sm:w-9 sm:h-9 text-orange-600" />
                    </div>
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 leading-tight">
                  ...
                  >
                      ...
                      <div className="flex justify-center gap-2 sm:gap-3">
                        {[...Array(4)].map((_, index) => (
                          <input
                            ...
                            className="w-12 h-12 sm:w-14 sm:h-14 text-center text-xl sm:text-2xl font-bold border-2 border-gray-300 focus:border-orange-500 focus:ring-3 focus:ring-orange-100 rounded-2xl bg-gray-50 focus:bg-white transition-all duration-200"
                            maxLength={1}
                            inputMode="numeric"
                          />
                        ))}
                    ...
                    <Button
                      ...
                      className="w-full h-12 sm:h-14 text-base sm:text-lg font-bold rounded-2xl bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50"
                    >
                      {isVerifyingOTP ? (
                        <div className="flex items-center justify-center gap-2">
                          <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 justify-center">
                              <Button
                                ...
                                className="text-orange-600 border-orange-200 hover:bg-orange-50 hover:border-orange-300 font-semibold rounded-xl"
                              >
                                {isVerifyingPhone ? (
